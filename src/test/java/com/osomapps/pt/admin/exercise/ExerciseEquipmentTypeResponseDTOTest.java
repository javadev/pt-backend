...
public class ExerciseEquipmentTypeResponseDTOTest {
    ...
    @Test
    public void setters() {
        ExerciseEquipmentTypeResponseDTO exerciseEquipmentTypeResponseDTO =
                new ExerciseEquipmentTypeResponseDTO().setId(null).setNameEn(null).setNameNo(null);
    ...
    public void getters() {
        ExerciseEquipmentTypeResponseDTO exerciseEquipmentTypeResponseDTO =
                new ExerciseEquipmentTypeResponseDTO();
