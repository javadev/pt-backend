...
public class AdminExerciseServiceTest {
    ...
    @Mock private ExerciseFilePreviewRepository exerciseFilePreviewRepository;
    @Mock private DictionaryService dictionaryService;
    @Mock private DataurlValidator dataurlValidator;

    @InjectMocks private AdminExerciseService tokenService;
    ...
    public void create() {
        ...
        exerciseRequestDTO.setFiles(
                Arrays.asList(
                        new ExerciseFileRequestDTO()
                                .setData_url(
        ...
        existedExerciseBodypart.setId(1L);
        existedExerciseBodypart.setDExerciseBodypartName("10");
        when(exerciseBodypartRepository.findById(eq(1L)))
                .thenReturn(Optional.of(existedExerciseBodypart));
        Exercise savedExercise = new Exercise();
        savedExercise.setId(1L);
        savedExercise.setDExerciseName("10");
        savedExercise.setExerciseBodypart(existedExerciseBodypart);
