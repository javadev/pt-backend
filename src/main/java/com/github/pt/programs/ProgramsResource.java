...
public class ProgramsResource {
    ...
    public List<ProgramResponseDTO> list() {
        ...
        workoutItem11.setBodyweight(inWorkoutItem11.getBodyweight());
        ...
        workoutItem12.setBodyweight(inWorkoutItem12.getBodyweight());
        ...
        workoutItem21.setBodyweight(inWorkoutItem21.getBodyweight());
        ...
        workoutItem22.setBodyweight(inWorkoutItem22.getBodyweight());
