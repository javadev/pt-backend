...
class ProgramService {
    ...
    List<ProgramResponseDTO> getExamples(String token) {
        ...
        inWorkoutItem111.setD_exercise_id("Exercise id 1 1");
        inWorkoutItem111.setD_exercise_name("Exercise name 1 1");
        ...
        inWorkoutItem112.setD_exercise_id("Exercise id 1 2");
        inWorkoutItem112.setD_exercise_name("Exercise name 1 2");
        ...
        inWorkoutItem121.setD_exercise_id("Exercise id 2 1");
        inWorkoutItem121.setD_exercise_name("Exercise name 2 1");
        ...
        inWorkoutItem122.setD_exercise_id("Exercise id 2 2");
        inWorkoutItem122.setD_exercise_name("Exercise name 2 2");
        ...
        inWorkoutItem211.setD_exercise_id("Exercise id 1 1");
        inWorkoutItem211.setD_exercise_name("Exercise name 1 1");
        ...
        inWorkoutItem212.setD_exercise_id("Exercise id 1 2");
        inWorkoutItem212.setD_exercise_name("Exercise name 1 2");
        ...
        inWorkoutItem221.setD_exercise_id("Exercise id 2 1");
        inWorkoutItem221.setD_exercise_name("Exercise name 2 1");
        ...
        inWorkoutItem222.setD_exercise_id("Exercise id 2 2");
        inWorkoutItem222.setD_exercise_name("Exercise name 2 2");
        ...
        inWorkoutItem311.setD_exercise_id("Exercise id 1 1");
        inWorkoutItem311.setD_exercise_name("Exercise name 1 1");
        ...
        inWorkoutItem312.setD_exercise_id("Exercise id 1 2");
        inWorkoutItem312.setD_exercise_name("Exercise name 1 2");
        ...
        inWorkoutItem321.setD_exercise_id("Exercise id 2 1");
        inWorkoutItem321.setD_exercise_name("Exercise name 2 1");
        ...
        inWorkoutItem322.setD_exercise_id("Exercise id 2 2");
        inWorkoutItem322.setD_exercise_name("Exercise name 2 2");
    ...
    private ProgramResponseDTO createProgramResponseDTO(InProgram inProgram) {
        ...
        for (InWorkout inWorkout : inProgram.getInWorkouts()) {
            ...
            for (InWorkoutItem inWorkoutItem : inWorkout.getInWorkoutItems()) {
                ...
                workoutItem.setExercise_id(inWorkoutItem.getD_exercise_id());
